...
static BASE_PENALTY: KeyMap<f64> = KeyMap([
	3.00, 1.00, 0.80, 0.40, 2.40,    2.40, 0.40, 0.80, 1.00, 3.00, 4.00,
	1.00, 0.25, 0.00, 0.00, 1.50,    1.50, 0.00, 0.00, 0.25, 1.00, 3.00,
	1.80, 1.00, 0.80, 0.40, 2.00,    2.00, 0.40, 0.80, 1.00, 1.80,
	                    0.0,    0.0]);
